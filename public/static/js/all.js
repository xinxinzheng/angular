// Source: public/static/js/index.js
/**
 * 
 * @authors zhengxinxin 
...
var App = angular.module('myApp',['ui.router','ngMessages','angular-markdown-editor','hc.marked', 'hljs'])
 ...
 .controller('addArticle',function(urlPre,$http,$rootScope,$scope,marked){
    ...
    $scope.saveArticle = () => {
    	$http({
    		method:'POST',
			url:urlPre + 'interfaces/save_article.php',
...
// Source: public/static/js/route/route.js
/**
 * 
...
// Source: public/static/js/filter/init.js
/**
 * 
...
// Source: public/static/js/ctrl/LoginCtrl.js
/**
 * 登录逻辑
 */
